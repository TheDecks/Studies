...
for ig in influence_groups:
    ...
    for _ in range(mc_steps):
        ...
        this_innovation = []
        this_imitation = []
        bd = BassDiffusionModelForce(complete_graph, p, q, influence_group_size=ig)
    ...
    inf_group_imitation[ig] = averaged_imitation
    inf_group_innovation[ig] = averaged_innovation
...
f, a = lp.labeler_plot_2(inf_group_imitation, inf_group_innovation, 'ig')
a.set_title(f'New adopters, CG(1000). p={p}, q={q}, ig=influence group size')
labeler_plot.plt.show()
